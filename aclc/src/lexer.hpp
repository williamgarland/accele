...
namespace acl {
    enum class TokenType {
        ...
        AS_UNWRAPPED, TRY_OPTIONAL, TRY_UNWRAPPED, ALIAS, EXTERN, FALL, GLOBAL,
    ...
    struct StringToken: public Token {
        ...
        StringToken(TokenType type, const String& data, const SourceMeta& meta, const Map<int, String>& interpolations);
        virtual ~StringToken();
    };
    ...
    private:
        ...
        void lexInterpolationEscapeSequence(int pos, Map<int, String>& interpolations);
